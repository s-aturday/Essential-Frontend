  ...
  return (
    <footer className="mt-16 border-t border-type-divider py-16 md:py-8">
      <WideContainer ultraWide classNames="grid md:grid-cols-2 gap-16 md:gap-8">
        ...
        <FooterLink icon={Icons.GITHUB} href={conf().GITHUB_LINK}>{t("footer.links.github")}</FooterLink>
<FooterLink icon={Icons.DISCORD} href={conf().DISCORD_LINK}>{t("footer.links.discord")}</FooterLink>
<FooterLink icon={Icons.MAIL} href={conf().EMAIL_LINK}>{t("footer.links.mail")}</FooterLink>
